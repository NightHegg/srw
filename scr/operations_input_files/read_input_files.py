...
def read_task(cur_task):
    ...
    with open(f"scr/operations_input_files/input_files/task_{cur_task}.dat") as f:
...
def read_mesh(cur_mesh):
    ...
    with open(f"scr/operations_input_files/input_files/mesh/mesh_{cur_mesh:.0e}.dat") as f:
        for _ in range(int(f.readline())):
